...
- **Services = Sub-agents** Lesson 4 คุณแยก /brief เป็น 3 specialist (fundamentals, earnings, sentiment, หรือชื่อที่คุณตั้งเอง) ทำงานขนาน แต่ละตัวเป็นไฟล์ใน `.claude/agents/<name>.md` skill เรียก by name นี่คือ "พนักงาน" ที่ OS layer เรียกใช้
...
4. **Lesson 4**: แตก /brief เป็น 3 sub-agent ที่นิยามเป็นไฟล์ใน `.claude/agents/` (fundamentals/earnings/sentiment) skill เรียก by name agents ทำงานขนาน

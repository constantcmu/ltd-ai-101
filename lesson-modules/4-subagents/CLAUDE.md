...
1. ถ้าทั้ง 3 ข้อผ่าน + window 2 ยังเปิด, say "ดีครับ ของจาก Lesson 3 พร้อม ไปดูปัญหาที่ skill ตัวเดียวเริ่มเจอ แล้วค่อยแตกเป็น sub-agent" Move to Step 1.
...
## ก่อนเริ่ม Lesson 4: escape hatch

ACTION: Before moving to Step 1, tell the student (in Thai narration):

**ถ้า lesson นี้ติด: ของจาก Lesson 3 ของคุณยังใช้งานได้นะครับ.** /brief v2 พร้อม external source ทำงานได้แล้วเป็นเครื่องมือจริง. lesson นี้คือ optimization layer (เร็วขึ้น + clean context) ไม่ใช่ requirement. ถ้าลองแล้ว sub-agent ไม่ fire ใน version คุณ หรือ debug นาน ข้าม Lesson 4 ไป Lesson 5 (deploy) ก่อนได้, กลับมา Lesson 4 ตอนหลัง. ของคุณยังครบ.
...
10-K มี: business segments breakdown, revenue mix, ลูกค้าหลัก, risk factors, capital structure, MD&A (management's discussion of analysis) — ของพวกนี้ไม่อยู่ใน earnings call transcript เพราะ transcript เน้นไตรมาสเดียว 10-K เน้นทั้งปี + structural

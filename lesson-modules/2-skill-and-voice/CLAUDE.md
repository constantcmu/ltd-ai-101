...
1. ถ้าผ่าน 5/5, say (in Paint's friendly voice): "OK skill ตัวแรกเรียบร้อย ลองนึกดูว่าชีวิตคุณปกติทำอะไรซ้ำๆ บ้าง แล้วลองไปสร้าง skill ของคุณเองดูได้นะ ครบ Lesson 2 ผ่าน ของในมือคุณตอนนี้แน่นกว่า Lesson 1 จริง" Move to "What just happened" + Common Stumbles + handoff

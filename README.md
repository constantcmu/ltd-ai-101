...
## 🎥 คลิป walkthrough คอร์สนี้

ผมทำคลิปเดินตามคอร์สนี้ให้ดู ตั้งแต่ติดตั้ง Claude Code จนจบ Lesson 1-2 ถ้าอยากเห็นภาพก่อนลงมือ ดูคลิปนี้ก่อนได้:

**▶️ https://youtu.be/mby89M6W-OM?si=4nasMBMBNEnKsgmn**

(คลิปครอบคลุม: setup Claude Code + Lesson 1 + Lesson 2. Lesson 3-5 ทำตามใน Claude Code ได้เลย)

...
- Lesson 5: deploy a showcase to Vercel + closing tour of how Paint's full AgyOS is built from these same pieces
...
5. Deploy + AgyOS recap (deploy a showcase page to Vercel, then a tour of how Paint's full AgyOS is built from the same primitives the student just used). File: `lesson-modules-agy/5-deploy-and-recap/AGY.md`
